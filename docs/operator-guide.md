...
- safety-critical escalation path (abrasive-wheel hazard, particulate
  exposure, hand/eye injury risk)
...
- a hard, unconditional block on any attempt to route a
  grinding/polishing-execution decision, or a shop-safety-officer
