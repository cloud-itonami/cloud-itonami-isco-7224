...
`cloud-itonami-isco-7224` accepts contributions to the OSS actor, policy tests,
...
- Do not commit real worker, workshop or operator data, credentials or operating
  documents.
- Keep production writes and disclosures behind Metal Polisher Governor.
...
- Never widen the closed op-allowlist to include a grinding/polishing-execution
